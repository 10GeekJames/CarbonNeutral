...
using CarbonNeutral.Identity.Admin.Api.Configuration;
using CarbonNeutral.Identity.Admin.Api.Configuration.Authorization;
using CarbonNeutral.Identity.Admin.Api.ExceptionHandling;
using CarbonNeutral.Identity.Admin.Api.Helpers;
using CarbonNeutral.Identity.Admin.Api.Mappers;
using CarbonNeutral.Identity.Admin.Api.Resources;
...
using CarbonNeutral.Identity.Shared.Dtos;
using CarbonNeutral.Identity.Shared.Dtos.Identity;

namespace CarbonNeutral.Identity.Admin.Api
{
