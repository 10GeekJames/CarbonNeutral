...
using CarbonNeutral.Identity.STS.Identity.ViewModels.Consent;
using CarbonNeutral.Identity.STS.Identity.ViewModels.Device;

namespace CarbonNeutral.Identity.STS.Identity.Controllers
{
    [Authorize]
    [SecurityHeaders]
