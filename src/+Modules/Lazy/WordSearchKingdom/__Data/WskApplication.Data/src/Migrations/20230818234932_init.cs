        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameGrids_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameGridInstances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameGridInstances_GameGrids_GameGridId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameGridInstances_GameGridId",
                table: "GameGridInstances",
                column: "GameGridId");

            migrationBuilder.CreateIndex(
                name: "IX_GameGrids_GameId",
                table: "GameGrids",
                column: "GameId");
