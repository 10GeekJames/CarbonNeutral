...
public static class WskGameTestData
{
    ...
    public static string NormalEasyGame1HiddenWords = Newtonsoft.Json.JsonConvert.SerializeObject(new List<string>() { new("Sally"), new("Billy"), new("Larry"), new("Franky"), new("George") });
    public static string NormalEasyGame1Categories = Newtonsoft.Json.JsonConvert.SerializeObject(new List<string>() { new("Shared"), new("Home"), new("School") });
    public static string NormalEasyGame1Tags = Newtonsoft.Json.JsonConvert.SerializeObject(new List<string>() { new("Fiction"), new("Adventure"), new("Action") });
    ...
    public static string NormalEasyGame2HiddenWords = Newtonsoft.Json.JsonConvert.SerializeObject(new List<string>() { new("Bishop"), new("Jalapeno"), new("Tomatoe"), new("Watermellon"), new("Tea") });
    public static string NormalEasyGame2Categories = Newtonsoft.Json.JsonConvert.SerializeObject(new List<string>() { new("Private") });
    public static string NormalEasyGame2Tags = Newtonsoft.Json.JsonConvert.SerializeObject(new List<string>() { new("Random") });
